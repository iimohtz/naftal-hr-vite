...
import { StatusBadge, Button, Avatar, Pagination, Modal, FormField, Input, Select } from '../../components/UI/UI'
...
function EmployeeFormModal({ employee, onClose }) {
  ...
  return (
    <Modal
      ...
      subtitle={isEdit ? 'Modify personnel record' : 'Register new personnel to the directory'}
      width={680}
    >
      ...
      <div className={styles.tableCard}>
        ...
        <div className={styles.toolbar}>
          ...
          <div className={styles.toolbarRight}>
            <div className={styles.searchBox}>
              <svg className={styles.searchIco} width="13" height="13" viewBox="0 0 13 13" fill="none">
        ...
        <div className={styles.tableWrap}>
          <table className={styles.table}>
            <thead>
              <tr>
                {['ID CODE','EMPLOYEE','DEPARTMENT','ROLE','SHIFT','STATUS','ATTENDANCE','ACTIONS'].map(h => (
                  ...
                  <td colSpan={8}>
                    <div className={styles.emptyState}>
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" opacity="0.3">
                        <circle cx="18" cy="12" r="7" stroke="currentColor" strokeWidth="1.5"/>
                  ...
                  <tr key={emp.id} className={styles.tr}>
                    ...
                    <td className={styles.td}>
                      ...
                      <div className={styles.empCell}>
                        <button className={styles.empAvatarBtn} onClick={() => setProfileEmp(emp)} title="View profile">
                          <Avatar name={emp.name} size={32} />
                        </button>
                        <div className={styles.empCellText}>
                          <button className={styles.empNameBtn} onClick={() => setProfileEmp(emp)}>
                            {emp.name}
                          </button>

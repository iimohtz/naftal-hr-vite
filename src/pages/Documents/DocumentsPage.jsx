...
/* ── Tab Icons ─────────────────────────────────────────────── */
const PayrollIcon = () => <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M11 3v14M7 7l4-4 4 4M7 15l4 4 4-4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>
const PassIcon    = () => <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><rect x="2" y="6" width="18" height="12" rx="2" stroke="currentColor" strokeWidth="1.6"/><path d="M2 10h18M6 14h2M10 14h6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg>
const LogIcon2    = () => <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M6 5h10a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2z" stroke="currentColor" strokeWidth="1.6"/><path d="M8 10h6M8 13h4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg>
const ExportIcon2 = () => <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M8 11l3-3 3 3M11 8v10M4 18h14" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>
...
function PassesTab() {
  ...
  return (
    <div className={styles.tabContent}>
      <div className={styles.tabToolbar}>
        <div className={styles.tabLeft}><div className={styles.accentBar}/><span className={styles.tabCardTitle}>GATE PASSES</span></div>
        <Button variant="primary" size="sm" onClick={() => setAddOpen(true)}>+ NEW PASS</Button>
      </div>
      <div className={styles.tableWrap}>
        <table className={styles.table}>
...
function LogsTab() {
  ...
  return (
    <div className={styles.tabContent}>
      <div className={styles.tabToolbar}>
        <div className={styles.tabLeft}><div className={styles.accentBar}/><span className={styles.tabCardTitle}>ACTIVITY LOG // GATE PASSES</span></div>
        <span className={styles.liveFeed}><span className={styles.livePulse}/>LIVE DATA FEED</span>
      </div>
      <div className={styles.tableWrap}>
        <table className={styles.table}>
